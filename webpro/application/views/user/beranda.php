  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block" style='text-align:left;'>
        <h1 class="display-4" class="left"><span class="font-weight-bold" > Selamat datang </span> <br> di Pettoshop !</h1> </span>
        <p>kami siap melayani anda dan hewan peliharaan anda</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="assets/img/pets.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Penyedia jasa penitipan hewan terpercaya</h5>
        <p>tempat hewan peliharaan anda bersenang-senang</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="assets/img/gambar3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Penitipan Hewan yang aman dan berkualitas</h5>
        <p>pelanggan puas kami pun puas</p>
      </div>
    </div>
  </div>
...
<div class="card text-center">    
  <div class="card-body">
    <div class="card text-center">
    <h1 class="card-title ">Sorry We're under Maintenance!</h1>
    <h5 class="card-text">Tapi tenang aja kok, kita masih terima jasa grooming untuk hewan kesayangan kamu </h5>
